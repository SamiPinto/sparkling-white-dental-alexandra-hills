...
const dentistLd = {
  ...
  description:
    "Porcelain and composite veneers in Alexandra Hills, Brisbane. Custom-made veneers to correct chips, gaps and staining, led by Dr Bikramjit (Dr Bik Sandhu) with more than 30 years of experience.",
  url: CANONICAL,
