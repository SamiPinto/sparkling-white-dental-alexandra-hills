    ...
    <>
      ...
      <div className="announce">
        <div className="container">
          <span>
            <strong>New patients welcome</strong> at our Alexandra Hills clinic
          </span>
        ...
        <div className="container">
          <div className="hero-anim">
            <div className="hero-badge">
              ...
              <span>
                Serving Alexandra Hills as <b>Dr. GP Nichols</b>, now Sparkling White
              </span>
            </div>
            <h1>
              Dentists in <br />
              <span className="accent">Alexandra Hills</span>
            </h1>
            <p className="hero-sub">
              Your trusted family dentist in Alexandra Hills — gentle,
              comprehensive care for every generation, all under one roof.
            </p>
            ...
            <div className="hero-trust">
              <div>
                ...
                <div className="t-text">
                  Loved by <b>Alexandra Hills families</b>
                </div>
              </div>
          ...
          <div className="hero-visual">
            <div className="hero-photo">
              <Image
                src={MEDIA.drBik}
                alt="Dr. Bik, Principal Dentist at Sparkling White Dental, Alexandra Hills"
                fill
                priority
              ...
              <div className="hero-photo-cap">
                ...
                <div className="cap-role">
                  Principal Dentist · Alexandra Hills clinic
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="about-visual reveal">
            <div className="about-photo">
              <Image
                src={MEDIA.team}
                alt="Dr. Bik with 3D dental-scan technology at Sparkling White Dental"
                fill
            ...
            <div className="about-card">
              <div className="ac-lead">
                ...
                <div className="ac-role">Principal Dentist · Alexandra Hills</div>
              </div>
              <div className="ac-stats">
                ...
                <div className="ac-stat">
                  <b>45</b>
                  <span>Years in Alexandra Hills</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="about-body reveal">
            ...
            <p>
              ...
              a reputable family dentist in Alexandra Hills, Brisbane. Under new
            ...
            <ul className="about-list">
              ...
              <li>
                ...
                One of the most reputable dental teams in the Redlands
              </li>
            </ul>
      ...
      <section className="stats-band">
        <div className="container">
          {[
            { b: "45+", s: "Years serving Alexandra Hills" },
            { b: "8+", s: "Specialised dental services" },
            { b: "30", s: "Years of clinical experience" },
            { b: "1", s: "Convenient Bluebell St clinic" },
          ].map((st) => (
      ...
      <section className="section video-sec">
        <div className="container">
          <div className="section-head center reveal">
            ...
            <h2>Step into our Alexandra Hills practice</h2>
            <p>
        ...
        <div className="container">
          <div className="emergency-card reveal">
            <div>
              ...
              <h2>Emergency dentist in Alexandra Hills</h2>
              <p>
      ...
      <section id="reviews" className="section reviews">
        <div className="container">
          <div className="section-head center reveal">
            ...
            <h2>Trusted by Alexandra Hills families for generations</h2>
            <p>
          ...
          <p className="reviews-caption">
            ...
            <b>5.0 / 5</b> by verified patients on Doctify
          </p>
        </div>
      </section>
      ...
      <section id="contact" className="section location">
        <div className="container">
          <div className="loc-card reveal">
            ...
            <h2>Sparkling White Dental, Alexandra Hills</h2>
          ...
          <div className="map-wrap reveal">
            <iframe
              title="Sparkling White Dental, Alexandra Hills — map"
              src={BIZ.mapEmbed}
              loading="lazy"
      ...
      <section className="final-cta">
        <div className="container">
          ...
          <p>
            Join the Alexandra Hills families who trust Sparkling White Dental. Book
      ...
      <footer className="footer">
        <div className="container">
          <div>
            ...
            <p className="f-about">
              Your trusted family dentist in Alexandra Hills, Brisbane — 45 years of
