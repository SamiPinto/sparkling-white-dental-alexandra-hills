// Central business data — sourced from sparklingwhitedental.com.au (Alexandra Hills location).
...
export const BIZ = {
  ...
  instagram: "https://www.instagram.com/sparklingwhitedentalbrisbane",
  logo: "/images/logo.webp",
  mapEmbed:
    "https://www.google.com/maps?q=1%20Bluebell%20St%2C%20Alexandra%20Hills%20QLD%204161&output=embed",
};
...
// Media — real photos & video pulled from the live Alexandra Hills location page.
export const MEDIA = {
  drBik: "/images/ah-dr-bik.webp", // Dr. Bik treating a patient with a digital scanner
  team: "/images/ah-about.webp", // Dr. Bik with 3D-scan technology (modern dentistry)
  doctify: "/images/doctify-badge.png", // "Recommended by patients on Doctify"
  vimeoId: "988732638", // "Alexandra Hills - Sparkling White Dental"
  videoPoster: "/images/video-poster.jpg", // Alexandra Hills video frame
  // Live Doctify verified-reviews carousel for the Alexandra Hills practice
  doctifyReviews:
    "https://www.doctify.com/wv2/average-carousel-rating-widget?containerId=040w47ok&dotsArrowsColor=0170a0&language=en&profileType=practice&slugs=sparkling-white-dental-alexandra-hills&tenantId=athena-au&theme=transparent&widgetName=average-carousel-rating-widget",
};
...
export const SERVICES = [
  ...
  },
  {
    ...
    tag: "Whitening & crowns",
    body: "Teeth whitening, veneers, bonding and same-day dental crowns — each treatment tailored to your aesthetic goals.",
  },
  {
    icon: "svc-implant",
...
export const FAQS = [
  {
    q: "Are you accepting new patients in Alexandra Hills?",
    a: "Yes — we warmly welcome new patients of all ages. You can book online 24/7 or call our friendly team on (07) 3824 2484 to arrange your first visit.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. As a trusted emergency dentist in Alexandra Hills, we prioritise urgent care such as toothache, broken or knocked-out teeth. Call us as early as possible in the day and we'll do our best to see you the same day.",
  },
  {
  ...
  },
  {
    ...
    a: "We're at 1 Bluebell St, Alexandra Hills, in the Redlands — easy to reach with convenient local parking. Contact us if you need directions for your visit.",
  },
];
