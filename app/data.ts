...
export const HERO = {
  ...
  eyebrowLocation: "Alexandra Hills (Brisbane)",
...
export const FAQS = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Leave your details below and our Alexandra Hills team will call you back the same day to confirm.",
    },
  ],
};
...
export const FORM = {
  ...
  sub: "Tell us a little about you and when you'd like to start — our Alexandra Hills team will call to confirm.",
