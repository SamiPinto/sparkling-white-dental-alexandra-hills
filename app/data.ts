...
export const GALLERY = {
  ...
  disclaimer:
    "Real patient results at Sparkling White Dental Alexandra Hills. Individual results vary. Photos shown with patient consent.",
  items: [
...
export const DOCTOR = {
  ...
  body: "With more than 30 years of experience, Dr Bikramjit and the team at Sparkling White Dental Alexandra Hills are known for gentle, unhurried care. We listen first, explain everything in plain English, and only ever recommend what you actually need.",
  photo: "/images/ah-about.webp",
...
export const FAQS = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Leave your details below with your preferred date, and our Alexandra Hills team will call you back the same day to confirm.",
    },
  ],
};
...
export const FORM = {
  ...
  sub: "Tell us a little about you and your preferred appointment time — our Alexandra Hills team will call to confirm.",
