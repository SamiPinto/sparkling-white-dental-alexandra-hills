...
export function VideoPlayer() {
    ...
    return (
      <div className="video-frame reveal in">
        <iframe
          ...
          title="Alexandra Hills — Sparkling White Dental"
  ...
  return (
    <button
      ...
      aria-label="Play the Sparkling White Dental Alexandra Hills video"
    >
      <Image
        src={MEDIA.videoPoster}
        alt="Sparkling White Dental clinic in Alexandra Hills"
        fill
      ...
      <span className="video-caption">Watch: inside our Alexandra Hills practice</span>
    </button>
  );
}
